...
-n\n\
    number of threads the program will use to connect simultaneously\n\
-h, --help\n\
    show help and exit.\n\
";
...
int main(int argc, char** argv)
{
    ...
    {
        threads.push_back(std::thread([]->int {
    ...
    std::cout << "\nTime took to run all clients: " << end - start << std::endl;
}